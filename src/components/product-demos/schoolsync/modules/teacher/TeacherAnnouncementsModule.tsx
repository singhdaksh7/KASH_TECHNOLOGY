...
export function TeacherAnnouncementsModule() {
  const [readStates, setReadStates] = useState<Record<string, boolean>>({});

  const teacherAnnouncements = ANNOUNCEMENTS.filter(a => a.audience === "all" || a.audience === "teachers");
    ...
    <div className="p-8 h-full flex flex-col relative">
      <div className="flex justify-between items-end mb-6">
        <div>
          ...
          <p className="text-muted text-sm">Official announcements for teaching staff.</p>
        </div>
      </div>
