...
const caseStudy = CASE_STUDIES["exora"];
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: `${caseStudy.title} | KASH Technologies`,
    description: caseStudy.description,
    url: `https://kash-technology.com/work/exora`,
  },
  alternates: {
    canonical: `https://kash-technology.com/work/exora`,
  }
};

export default function ExoraCaseStudyPage() {
  return (
    <main className="min-h-screen bg-background pt-24 pb-12">
      ...
      <InteractiveDemoSection disclaimer="This interactive prototype uses fictional local data and does not execute real financial operations or connect to live trading APIs.">
        <ExoraDemo />
