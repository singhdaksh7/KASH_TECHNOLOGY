...
export const metadata: Metadata = {
  title: "AI & Business Automation Solutions Company | Delhi NCR | KASH Technology",
  description: "Custom AI integration, LLM agent development, document OCR parsing, and business process automation for enterprises in Delhi NCR and Western UP.",
  alternates: {
  ...
  openGraph: {
    title: "AI & Business Automation Solutions Company | Delhi NCR | KASH Technology",
    description: "Custom AI integration, LLM agent development, document OCR parsing, and business process automation for enterprises in Delhi NCR and Western UP.",
    url: "https://kash-technology.com/ai-automation",
  },
};

const FEATURES = [
  {
    "title": "Custom LLM Agents & Semantic Search",
    "desc": "Secure Retrieval-Augmented Generation (RAG) agents trained on your proprietary product docs, SOPs, and company data."
  },
  {
    "title": "Automated Document & Invoice OCR",
    "desc": "Extract structured data from scanned invoices, purchase orders, identity proofs, and contracts directly into your database."
  },
  {
    "title": "Intelligent 24/7 WhatsApp & Web Bots",
    "desc": "Conversational agents that qualify inbound prospects, answer technical questions, and book consultation calls automatically."
  },
  {
    "title": "Predictive Analytics & Demand Forecasting",
    "desc": "Machine-learning models analyzing historical sales to predict seasonal demand, inventory replenishment, and customer churn."
  },
  {
    "title": "Strict Data Privacy & Local Models",
    "desc": "Enterprise guardrails ensuring customer data is never shared with public AI training pools, with support for self-hosted models."
  },
  {
    "title": "Automated Workflow Queues",
    "desc": "Background worker pipelines that automatically categorize incoming emails, tag tickets, and generate executive summaries."
  }
];

const FAQS = [
  {
    "question": "How can AI practically help our business today?",
    "answer": "AI delivers immediate value in three areas: automating repetitive data entry (e.g. invoice extraction), providing 24/7 intelligent customer inquiry handling, and summarizing complex internal operational data."
  },
  {
    "question": "Is our proprietary business data safe when using your AI systems?",
    "answer": "Yes. We use private enterprise API endpoints with zero-data-retention agreements or deploy self-hosted open-source models inside your private cloud."
  }
];
...
export default function ServicePage() {
  return (
    <>
      ...
      <HeroDiagonal
        badge="INTELLIGENT AI AUTOMATION"
        titlePrimary="Intelligent AI Automation Systems for"
        titleAccent="Modern Enterprises"
        description="We integrate production AI capabilities into your business: automated invoice extraction, intelligent customer support agents, document parsing, and background decision bots that save hundreds of staff hours."
